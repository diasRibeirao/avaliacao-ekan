...
import br.com.ekan.avaliacao.controller.validation.beneficiario.BeneficiarioCadastrar;
...
@Data
@BeneficiarioCadastrar
public class BeneficiarioCadastrarDTO {
    ...
    @Schema(type = "string",
            pattern = "^(?:(?:\\+|00)55|)(?:\\s|-)?(?:\\(?0?\\d{2}\\)?\\s?)(?:\\s|-)?(?:9\\d{4})\\-?\\d{4}$",
    ...
    private @Valid List<DocumentoCadastrarDTO> documentos;
